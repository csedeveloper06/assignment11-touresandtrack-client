  ...
  return (
    <div className="box-border bg-violet-200 pb-10 rounded-xl shadow-xl lg:mt-20 mb-16">
      ...
      <form onSubmit={handleLogin} className="w-3/4 lg:w-1/2 mx-auto">
        ...
        <div className="form-control mt-6">
          ...
          <button
            ...
            className="btn flex items-center justify-center gap-3 m-3"
          >
            <img
              className="w-10 h-10 rounded-full"
              src="https://i.ibb.co/xfBDPKW/google1.png"
              alt=""
            />
            Login With Google
          </button>
      ...
      <p className="text-center m-5">
        ...
        <Link className="to-blue-600 font-bold ml-3" to="/register">
          Register
        </Link>
      </p>
      {loginError && <p className="text-red-600 text-center">{loginError}</p>}
      {loginSuccess && (
        <p className="text-green-600 text-center">{loginSuccess}</p>
      )}
    </div>
  );
};
